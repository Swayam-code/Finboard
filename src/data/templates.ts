    ...
    widgets: [
      {
        ...
        name: 'Apple Stock',
        title: 'Apple (AAPL)',
        apiUrl: `https://finnhub.io/api/v1/quote?symbol=AAPL&token=${process.env.NEXT_PUBLIC_FINNHUB_API_KEY}`,
        refreshInterval: 30,
        selectedFields: ['c'],
        displayField: 'c',
        position: { x: 0, y: 0 },
      ...
      },
      {
        ...
        name: 'Google Stock',
        title: 'Google (GOOGL)',
        apiUrl: `https://finnhub.io/api/v1/quote?symbol=GOOGL&token=${process.env.NEXT_PUBLIC_FINNHUB_API_KEY}`,
        refreshInterval: 30,
        selectedFields: ['c'],
        displayField: 'c',
        position: { x: 300, y: 0 },
      ...
      },
      {
        ...
        name: 'Market News',
        title: 'Market News',
        apiUrl: `https://finnhub.io/api/v1/news?category=general&token=${process.env.NEXT_PUBLIC_FINNHUB_API_KEY}`,
        refreshInterval: 300,
    ...
    widgets: [
      {
        ...
        apiUrl: `https://api.polygon.io/v2/aggs/ticker/SPY/prev?adjusted=true&apikey=${process.env.NEXT_PUBLIC_POLYGON_API_KEY}`,
        refreshInterval: 30,
      ...
      },
      {
        ...
        apiUrl: `https://api.polygon.io/v2/aggs/ticker/QQQ/prev?adjusted=true&apikey=${process.env.NEXT_PUBLIC_POLYGON_API_KEY}`,
        refreshInterval: 30,
        selectedFields: ['results.0.c'],
        displayField: 'results.0.c',
        position: { x: 320, y: 0 },
